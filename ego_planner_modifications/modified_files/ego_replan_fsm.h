...
namespace ego_planner
{
  ...
  private:
    ...
    double z_max_;
    bool backoff_enable_;
    double backoff_dist_;
    double backoff_cooldown_sec_;
    rclcpp::Time last_backoff_time_;
    ...
    rclcpp::Publisher<std_msgs::msg::Empty>::SharedPtr replan_attempt_pub_;
